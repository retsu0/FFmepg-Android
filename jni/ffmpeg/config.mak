...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=../ffmpeg-build/armeavi-v7a-neon --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc --cross-prefix=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi- --nm=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-nm --sysroot=/home/retsu/android-ndk/platforms/android-9/arch-arm/ --extra-cflags=' -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  ' --disable-shared --enable-static --enable-runtime-cpudetect --extra-ldflags='-Wl,-rpath-link=/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -L/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib  -nostdlib -lc -lm -ldl -llog -L../ffmpeg-build/armeavi-v7a-neon/lib' --extra-cflags=-I../ffmpeg-build/armeavi-v7a-neon/include --disable-everything --enable-libass --enable-libvo-aacenc --enable-libvo-amrwbenc --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_vaapi --enable-hwaccel=h264_dxva2 --enable-hwaccel=mpeg4_vaapi --enable-demuxer=ac3 --enable-demuxer=flv --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=mpegvideo --enable-demuxer=h263 --enable-demuxer=mpegps --enable-demuxer=mjpeg --enable-demuxer=rtsp --enable-demuxer=rtp --enable-demuxer=hls --enable-demuxer=matroska --enable-demuxer=mp3 --enable-demuxer=pcm_u16le --enable-demuxer=pcm_s16le --enable-demuxer=pcm_u16be --enable-demuxer=pcm_s16be --enable-demuxer=ogg --enable-muxer=null --enable-muxer=mp2 --enable-muxer=flv --enable-muxer=rtsp --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mjpeg --enable-muxer=matroska --enable-muxer=wav --enable-muxer=pcm_u16le --enable-muxer=pcm_s16le --enable-muxer=pcm_u16be --enable-muxer=pcm_s16be --enable-muxer=ogg --enable-protocol=crypto --enable-protocol=file --enable-protocol=rtp --enable-protocol=tcp --enable-protocol=udp --enable-protocol=hls --enable-protocol=http --enable-decoder=mp3 --enable-decoder=flv --enable-decoder=xsub --enable-decoder=jacosub --enable-decoder=dvdsub --enable-decoder=dvbsub --enable-decoder=subviewer --enable-decoder=rawvideo --enable-decoder=mjpeg --enable-decoder=h263 --enable-decoder=mpeg4 --enable-decoder=h264 --enable-decoder=aac --enable-decoder=mp2 --enable-decoder=amrwb --enable-decoder=amrnb --enable-decoder=ac3 --enable-decoder=flac --enable-decoder=pcm_u16le --enable-decoder=pcm_s16le --enable-decoder=pcm_u16be --enable-decoder=pcm_s16be --enable-encoder=flv --enable-encoder=rawvideo --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=mp2 --enable-encoder=pcm_u16le --enable-encoder=pcm_s16le --enable-encoder=pcm_u16be --enable-encoder=pcm_s16be --enable-encoder=libvo_amrwbenc --enable-parsers --enable-parser=h264 --enable-parser=h263 --enable-parser=flac --enable-parser=aac --enable-parser=ac3 --enable-parser=mpegaudio --enable-parser=mpegvideo --enable-parser=mpeg4video --enable-bsfs --enable-decoders --enable-encoders --enable-hwaccels --enable-muxers --enable-avformat --enable-avcodec --enable-avresample --enable-zlib --disable-decoder=vorbis --disable-encoder=vorbis --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avfilter --disable-avdevice --enable-libvorbis --enable-nonfree --enable-version3 --enable-memalign-hack --enable-asm --cpu=armv7-a --enable-neon
...
ARCH=arm
CC=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
CXX=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
AS=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LD=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCC=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  -I/home/retsu/FFmpeg-Android/jni/ffmpeg-build/armeabi-v7a/include/freetype2 --sysroot=/home/retsu/android-ndk/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC
CFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  -I/home/retsu/FFmpeg-Android/jni/ffmpeg-build/armeabi-v7a/include/freetype2  -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__ -I../ffmpeg-build/armeavi-v7a-neon/include -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -I/home/retsu/FFmpeg-Android/jni/libass/../ffmpeg-build/armeavi-v7a-neon/include -I/home/retsu/FFmpeg-Android/jni/fribidi/../ffmpeg-build/armeavi-v7a-neon/include/fribidi -I/Users/fschuetz/Dropbox/devel/android/FFMpeg/jni/freetype2/../ffmpeg-build/x86/include/freetype2 -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=-mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  -I/home/retsu/FFmpeg-Android/jni/ffmpeg-build/armeabi-v7a/include/freetype2  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -finline-limit=300 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__ -I../ffmpeg-build/armeavi-v7a-neon/include -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-windres
DEPWINDRES=/home/retsu/android-ndk/toolchains/arm-linux-androideabi-4.6/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
LDFLAGS= -Wl,-rpath-link=/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -L/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -lc -lm -ldl -llog -Wl,-rpath-link=/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -L/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -nostdlib -lc -lm -ldl -llog -L../ffmpeg-build/armeavi-v7a-neon/lib  --sysroot=/home/retsu/android-ndk/platforms/android-9/arch-arm/ -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS=-lvorbisenc -lvorbis -logg -lvo-amrwbenc -lvo-aacenc -L/home/retsu/FFmpeg-Android/jni/libass/../ffmpeg-build/armeavi-v7a-neon/lib -L/home/retsu/FFmpeg-Android/jni/fribidi/../ffmpeg-build/armeavi-v7a-neon/lib -L/Users/fschuetz/Dropbox/devel/android/FFMpeg/jni/freetype2/../ffmpeg-build/x86/lib -lass -lm -lfribidi -lfreetype -lm -lz -pthread -lgcc 
...
libavutil_VERSION=52.64.100
libavutil_VERSION_MAJOR=52
libavutil_VERSION_MINOR=64
