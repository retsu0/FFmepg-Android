...
#
CPPFLAGS := -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__ 
CFLAGS   := -c -Wall -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a8 -mthumb -D__thumb__  -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -Wl,-rpath-link=/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib -L/home/retsu/android-ndk/platforms/android-9/arch-arm//usr/lib  -lc -lm -ldl -llog -march=armv7-a -lz
