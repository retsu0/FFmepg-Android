...
public class FFmpegPlayer {
	...
	private static class SetDataSourceTask extends
		...
		protected SetDataSourceTaskResult doInBackground(Object... params) {
			...
			int err = player.setDataSourceNative(path, map, videoStreamNo, audioStreamNo, subtitleStreamNo);
	...
	public void setDataSource(String path, Map<String, String> dictionary,
			int videoStream, int audioStream, int subtitlesStream) {
		new SetDataSourceTask(this).execute(path, dictionary,
				Integer.valueOf(videoStream), Integer.valueOf(audioStream),
				Integer.valueOf(subtitlesStream));
	}
	
	public void setDataSource(String path) {
		setDataSource(path, null, UNKNOWN_STREAM, UNKNOWN_STREAM, NO_STREAM);
	}
